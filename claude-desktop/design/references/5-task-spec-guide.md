...
- Roadmap from `[slug]-roadmap.md` (Stage 3 output)
...
## Output
`[slug]-task-spec.md` artifact using `assets/templates/5-task-spec.md`

Example: `core-task-spec.md`, `cloud-deployment-task-spec.md`
...
## Next Stage
-> Hand off to implementation (manual, Claude Code dev-cycle, or other tools)
